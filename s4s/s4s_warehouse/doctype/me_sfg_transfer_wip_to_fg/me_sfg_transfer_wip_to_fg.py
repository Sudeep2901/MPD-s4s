...
class MESFGTransferWIPtoFG(Document):
	def on_submit(self):
		self.create_stock_entry()

	def create_stock_entry(self):
		if not frappe.db.get_value("Stock Entry",{'me_sfg_transfer_wip_to_fg':self.name},['name']):
			...
			stock_entry.me_sfg_transfer_wip_to_fg = self.name

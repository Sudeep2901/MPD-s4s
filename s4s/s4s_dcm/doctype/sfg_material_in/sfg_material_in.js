...
frappe.ui.form.on('SFG Material In', {
				...
				callback:function(r){
					if(r.message){
						if(r.message == "Success"){
							frm.add_custom_button(__('Create QC Check List'), function () {
								frappe.model.open_mapped_doc({
									method: "s4s.s4s_dcm.doctype.sfg_material_in.sfg_material_in.create_qc_checklist",
									frm: cur_frm
								})

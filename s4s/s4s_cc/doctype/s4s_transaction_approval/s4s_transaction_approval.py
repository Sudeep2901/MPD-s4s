...
class S4STransactionApproval(Document):
	@frappe.whitelist()
	def get_data(self):
		...
		for dataset in query:
			if not frappe.db.get_value("S4S Transaction Approval Item",{"transaction_no":dataset.get("s4s_p_name"),"docstatus":["in",[0,1]],"parent":["!=",self.name]},["parent"]):

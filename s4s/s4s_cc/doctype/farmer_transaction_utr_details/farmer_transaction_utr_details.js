...
frappe.ui.form.on('Farmer Transaction UTR Details', {
	setup: function(frm){
		if (frm.doc.company) {
			...
			callback:function(r){
				if (r.message != "No Records"){
					...
					data.forEach(element => {
						...
						c.purchase_receipt1 = element.pur_rect
						c.purchase_invoice = element.purchase_inv
						c.payment_entry = element.pe_name
